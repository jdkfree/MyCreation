...
public class TitleA
{
	...
	for (int i = 0 ; i <= 640 ; i++)
	{
	    drawLine (i, 0, i, 500, cPurple);
	}
	c.setColor (cBlack);
	c.setFont (new Font ("Broadway", 1, 48));
	c.drawString ("Attack of the", 120, 200);
	c.drawString ("Pizza Delivery", 170, 250);
	c.setFont (new Font ("Serif", Font.PLAIN, 12));
	c.drawString ("By Justin Freemantle", 450, 480);
	try
	{
	    Thread.sleep (1500);
	}
